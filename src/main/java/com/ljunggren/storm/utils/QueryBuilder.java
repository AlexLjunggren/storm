...
public class QueryBuilder {
    ...
    public String buildInsertSQL() {
        ...
        return String.format("insert into %s (%s) values (%s)", table, StringUtils.join(columns, ", "), StringUtils.join(questionMarks, ", "));
    }
    ...
    public String buildUpdateSQL() {
        ...
        return String.format("update %s set %s where %s = ?", table, StringUtils.join(columns, ", "), idName);
    }
    ...
    public String buildDeleteSQL() {
        String table = getTableName(object.getClass());
        String idName = idField.getName();
        return String.format("delete from %s where %s = ?", table, idName);
    }
